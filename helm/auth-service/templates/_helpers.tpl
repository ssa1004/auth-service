...
{{/*
fullname — release-name + chart-name. 너무 길면 잘라냄.
*/}}
...
{{/*
chart 식별자 — Helm 표준 label 의 helm.sh/chart 에 사용.
*/}}
...
{{/*
selector label — Deployment selector / Service selector 에 사용.
*/}}
...
{{/*
이미지 reference — tag 가 비어있으면 .Chart.AppVersion fallback.
*/}}
