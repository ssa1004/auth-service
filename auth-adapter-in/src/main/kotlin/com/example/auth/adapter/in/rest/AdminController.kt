...
class AdminController(
    ...
    /**
     * 운영자가 사용자에 role 부여. 실제로는 `admin:write` permission 필요 — JWT
    ...
    fun assignRole(
        ...
        @RequestBody @NotNull req: AssignRoleRequest,
        http: HttpServletRequest,
    ): ResponseEntity<Void> {
        assignRoleUseCase.assign(
            AssignRoleUseCase.Command(
    ...
    @JvmRecord
    data class AssignRoleRequest(@field:NotNull val roleId: UUID)
}
